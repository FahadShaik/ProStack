...
for (employee of employees) {
  ...
  tDataOne.innerHTML = empId;

  const tDataTwo = document.createElement("td");
  const empName = employee.name;
  tDataTwo.innerHTML = empName;

  const tDataThree = document.createElement("td");
  const empEmail = employee.email;
  tDataThree.innerHTML = empEmail;

  const tDataFour = document.createElement("td");
  const empGender = employee.gender;
  tDataFour.innerHTML = empGender;

  newRow.appendChild(tDataOne);
  newRow.appendChild(tDataTwo);
  newRow.appendChild(tDataThree);
  newRow.appendChild(tDataFour);
  tableBody.appendChild(newRow);
}
